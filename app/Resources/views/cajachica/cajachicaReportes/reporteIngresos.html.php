      ...
      <div >
             ...
             <div style="height: 120px; margin-bottom: -20px;">
              ...
              <table>
                    ...
                    <tr>
                        <td colspan="5" style="font-size: 20px; font-weight: 600;text-transform: uppercase;"> Reporte de ingresos en caja chica</td>
                    </tr>
                    <tr>
       ...
       <table style="border: 2px solid #3C2D2D; ">
        <thead>
            <tr style="background-color: #f2f2f2;">
                ...
                <th class="thClass">Persona que entrego</th>
                <th class="thClass">Persona que recibio</th>
        ...
        <div style="margin-top: 20px; margin-left: 418px;">
              <table>
                   <tr>
